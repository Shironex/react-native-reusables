    ...
    <View className='flex-1 justify-center items-center gap-5 p-6 bg-secondary/30'>
      <Card className='w-full max-w-sm p-6 rounded-2xl'>
        <CardHeader className='items-center'>
          <CardTitle className='pb-2 text-center'>Wypożyczone Leżaki</CardTitle>
        </CardHeader>
        <CardContent>
          <View>
            <Button
      ...
      <Card className='w-full max-w-sm p-6 rounded-2xl'>
        <CardHeader className='items-center'>
          <CardTitle className='pb-2 text-center'>Oddane Leżaki</CardTitle>
        </CardHeader>
        <CardContent>
          <View>
            <Button
        ...
        <CardContent>
          <View>
            <Button
              ...
              className='shadow shadow-foreground/5'
            >
              <Link to={'/summarry'} className='w-full text-center'>
                <Text>Przejdź</Text>
              </Link>
            </Button>
          </View>
